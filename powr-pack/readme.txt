...
Yes, you need a POWR Account. Your account allows you to create as many plugins as you need for your WordPress site with only one login. You can also edit your plugins right in your live WordPress site and embed your plugins on any site outside of WordPress.

= How do I add a POWR Plugin to a page or blog post? =
• Open POWR in your WordPress Dashboard.
• Choose your plugin and click to edit it in the POWR Editor.
• Once you have finished customizing, click Publish in the top right.
...
• Once you have finished customizing, click Publish in the top right.
• You will be prompted to create a POWR account if you don’t already have one.
• After you’ve customized your plugin and created your account, go to your WordPress Dashboard and click Appearance > Widgets.
• Find and drag the POWR Plugins widget into the Header, Homepage or Sidebar section.
• Select the plugin you would like to install in this section and click Save.
• You can now edit the plugin from your WordPress Dashboard, or on your live WordPress site.

= Are POWR Plugins free? =
Yes, all POWR plugins are available 100% free. You can access the [full library](https://www.powr.io/plugins) of 60 plugins from your POWR account. Upgrades are available for more advanced features.

= What upgrades are available? =
You can upgrade each plugin individually to benefit from advanced features and to remove the POWR branding. The individual plugin upgrade plans are Starter or Pro. If you would like to upgrade several plugins, you can get unlimited access to all plugins on the [Business plan](https://www.powr.io/business). Full pricing information can be found [here](https://www.powr.io/pricing). Simply search for your plugin.
...
• Send custom autoresponder emails to new sign ups.

= How do I edit my plugins? =
You can easily edit your plugins right from your live WordPress site. You’ll see an ‘Edit’ icon above your plugin (don’t worry, it’s only visible to you). Click on it to open the POWR Editor and make any changes you need. Your changes with automatically save.
